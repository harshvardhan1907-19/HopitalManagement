...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />
    <h3 class=" " data-delay="0" 
        style="box-sizing: border-box; background: rgb(255, 255, 255); border: 0px; font-size: 20px; margin: 0px 0px 20px; outline: 0px; padding: 0px; vertical-align: baseline; line-height: normal; font-weight: 700; font-family: Lato; letter-spacing: normal; text-transform: none; color: rgb(45, 45, 41); font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; orphans: 2; text-align: start; text-indent: 0px; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">
        <asp:Label ID="Label23" runat="server" Font-Bold="True" Font-Size="XX-Large" 
            Text="Appointment Form"></asp:Label>
    </h3>
    <br />
    <table cellpadding="0" cellspacing="0" class="style1">
        ...
        <tr>
            ...
            <td class="style4">
                Phone<asp:RequiredFieldValidator ID="RequiredFieldValidator5" 
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator7" 
    ...
    <asp:Button ID="Button1" runat="server" Height="59px" Text="SUBMIT" 
        Width="149px" style="text-align: center" align="rigth" onclick="Button1_Click" 
                ...
                <td>
                    <asp:Button ID="BTNSchedule" runat="server" Height="59px" 
                        onclick="BTNSchedule_Click" Text="Schedule" 
                        Width="171px" CssClass="BTN1" Font-Bold="True" />
                </td>
            </tr>
</table>
        <br />
